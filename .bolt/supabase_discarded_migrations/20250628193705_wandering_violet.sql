/*
  # User Documents and File Management

  1. New Tables
    - `user_documents` - Track uploaded documents and files
  ...
  2. Security
    ...
    - Allow viewing of public document types

  3. Features
    - Document type classification (avatar, attachment, document, certification)
