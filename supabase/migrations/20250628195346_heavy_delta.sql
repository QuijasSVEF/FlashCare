/*
  ...
  1. New Tables
    - `user_documents`
      ...
      - `document_type` (text, enum: avatar, attachment, document, certification)
  ...
  2. Security
    ...
    - Add policies for viewing public document types (certifications, avatars)
    - Add policies for viewing documents from matched users
